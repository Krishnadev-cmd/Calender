...
-- 2. Create sellers table (business profiles for sellers)
...
-- 4. Create google_calendar_tokens table (for OAuth tokens)
...
/*
-- Sample seller profiles (you'll need to replace UUIDs with actual user IDs)
INSERT INTO public.sellers (user_id, business_name, description, location) VALUES
('your-user-id-here', 'Tech Consulting', 'Expert web development and consulting services', 'New York, NY'),
('another-user-id', 'Design Studio', 'Creative design solutions for modern businesses', 'San Francisco, CA');
*/
